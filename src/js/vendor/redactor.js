/*eslint no-extend-native:0, vars-on-top:0, eqeqeq:0, no-use-before-define:0,curly:0,no-mixed-spaces-and-tabs:0, no-multi-spaces:0, key-spacing:0, no-ternary:0, no-undef:0, no-empty:0, no-unused-vars:0, consistent-return:0, space-infix-ops:0, no-shadow:0, no-redeclare:0, no-loop-func:0, no-control-regex:0, no-cond-assign:0, default-case:0, no-extra-boolean-cast:0, one-var:0 */
